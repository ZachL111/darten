...
darten is a Dart project for offline sync. It focuses on this technical goal: Model offline note edits, vector clocks, and deterministic conflict resolution.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 176, risk penalty 6, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
