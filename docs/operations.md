...
`darten` is centered on offline sync work in Dart. The technical target is: Model offline note edits, vector clocks, and deterministic conflict resolution.
...
The score is deterministic. The current threshold is 176. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 3.
